  ...
  return (
    ...
    <div className="how-to-page">
      ...
      <section className='how-to-section'>
        ...
        within a few minutes, if you find you are not getting pain relief you may be working the wrong spot.
        </p></div>
        ...
        <p> Using deep pressure, press and hold a trigger point until you feel the pain begin to subside.
          ...
          until the pain subsides. Often trigger point pain will subside within a few minutes, if you find you are
          not getting relief you may be working the wrong spot.
        </p>
        </div>
